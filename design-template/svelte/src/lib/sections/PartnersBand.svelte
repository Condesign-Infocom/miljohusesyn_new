<script>
  let { label = 'I samarbete med' } = $props();
</script>
...
<section class="border-y border-line/70 bg-cream-2/60">
  ...
  >
    ...
    <span>LRF</span>
    <span class="hidden h-1 w-1 rounded-full bg-line md:inline-block"></span>
    <span>Sigill Kvalitetssystem AB</span>
    <span class="hidden h-1 w-1 rounded-full bg-line md:inline-block"></span>
    <span>Jordbruksverket</span>
    <span class="hidden h-1 w-1 rounded-full bg-line md:inline-block"></span>
    <span>Naturvårdsverket</span>
    <span class="hidden h-1 w-1 rounded-full bg-line md:inline-block"></span>
    <span>Berörda branschorganisationer</span>
  </div>
</section>
